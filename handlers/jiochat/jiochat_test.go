...
func setupServerAndBackend() (mb *courier.MockBackend, s courier.Server) {
	mb = courier.NewMockBackend()
	conn := mb.RedisPool().Get()
...
func TestSending(t *testing.T) {
	...
	RunChannelSendTestCases(t, defaultChannel, newHandler(), defaultSendTestCases, setupServerAndBackend)
}
